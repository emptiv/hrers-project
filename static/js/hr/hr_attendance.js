/**
 * hr_attendance.js
 * Comprehensive logic for HR Attendance Log & Dashboard
 * ============================================================
 */
...
// Inline Weekly Table (Dashboard Summary Card)
...
/**
 * Fetches the HR Staff's personal info to fill the UI cards.
 */
async function loadEmployeeDetails() {
    try {
        ...
        if (employeeTab) employeeTab.textContent = profile.fullName || 'HR Staff';
...
if (tabLog && tabMonit) {
    ...
    tabMonit.addEventListener('click', () => {
        window.location.href = '/templates/hr/hr_attendancemonitoring.html';
    });
}
