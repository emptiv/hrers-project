...
function getBasicInputs() {
    return document.querySelectorAll('#editHeadForm .form-section-box:first-child .input-item input');
}
    ...
    submitProfileUpdate()
        .then(() => {
            if (window.Swal) {
                ...
                return Toast.fire({ icon: 'success', title: 'Success!', text: 'Head profile has been updated.' });
            }
