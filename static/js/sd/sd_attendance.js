/**
 * director_attendance.js
 * Comprehensive logic for School Director Attendance Log & Dashboard
 * ============================================================
 */
...
// Inline Weekly Table (Dashboard Card Summary)
...
/**
 * Fetches the Director's details for the info cards.
 */
async function loadEmployeeDetails() {
    try {
        ...
        if (employeeTab) employeeTab.textContent = profile.fullName || 'School Director';
        ...
        if (detailItems.length >= 4) {
            ...
            detailItems[1].textContent = profile.position || profile.roleLabel || 'Director';
            detailItems[2].textContent = profile.department || 'Administration';
...
/* ── 6. HISTORY MODAL LOGIC (ACTION COLUMN REMOVED) ──────── */
